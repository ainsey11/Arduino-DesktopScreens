...
openhab = openHAB(OpenHabURL) # Start the openhab connection / lib up as slow asf
...
while True:
	...
	openhabconnection =  urllib2.urlopen('http://' + ArduinoIP + '?L1=Outdoor+Conditions:' + '&L2=' + temp + 'C' + condition)
